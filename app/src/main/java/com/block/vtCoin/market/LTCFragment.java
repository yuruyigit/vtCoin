...
public class LTCFragment extends BaseFragment {
    ...
    public boolean isFirstLoad = false;//被销毁，第一次进时需要加载进度条，其他时候不要
    ...
    private void initPresenter() {
        ...
        convertPresenter.setModelView(new MyModel<MarketEntity>(), new ConvertViewImpl(this,CoinType.LTC));
        marketPresenter = new MarketPresenter();
        marketPresenter.setModelView(new MyModel<MarketEntity>(), new MarketViewImpl(this, CoinType.LTC));
    }
    ...
    private void loadData() {
        if (MarketFragment.isLtcCurrent) {
            L.i("加载数据");
            loadDialog();
