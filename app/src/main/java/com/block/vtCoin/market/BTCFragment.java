...
public class BTCFragment extends BaseFragment {
    ...
    private void initPresenter() {
        ...
        convertPresenter.setModelView(new MyModel<MarketEntity>(), new ConvertViewImpl(this,CoinType.BTC));
        marketPresenter = new MarketPresenter();
        marketPresenter.setModelView(new MyModel<MarketEntity>(), new MarketViewImpl(this, CoinType.BTC));
    }
    ...
    private void loadData() {
        if (MarketFragment.isBtcCurrent) {
            loadDialog();
