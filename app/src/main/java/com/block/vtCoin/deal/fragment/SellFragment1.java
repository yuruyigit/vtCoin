...
public class SellFragment1 extends BaseFragment {
    ...
    private void initPresenter() {
        ...
        queryOrderPresenter.setModelView(new MyModel<QueryOrder>(), new QueryOrderViewImpl(this, 1));
        chatTokenPresenter = new ChatTokenPresenter();
        chatTokenPresenter.setModelView(new MyModel<ChatTokenEntity>(), new ChatTokenViewImpl(this, 1));
        dealPricePresenter = new DealPricePresenter();
        dealPricePresenter.setModelView(new MyModel<DealPriceEntity>(), new DealPriceViewImpl(this, 1));
    }
    ...
    protected void initView() {
        ...
        refreshLayout.setOnRefreshListener(new RefreshListenerAdapter() {
            ...
            public void onRefresh(final TwinklingRefreshLayout refreshLayout) {
                ...
                isRefresh = true;
                pageIndex = 1;
                queryOrderPresenter.queryOrder(new PageEntity(0, new Page(pageIndex, pageList)), 1);
            }
        ...
        if (DealFragment1.isSellCurrent)
    ...
    public void refreshUi() {
        if (isTokenSuccess && isPriceSuccess && isPriceChanged) {
