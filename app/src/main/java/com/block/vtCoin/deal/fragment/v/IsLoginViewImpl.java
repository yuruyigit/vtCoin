...
public class IsLoginViewImpl implements ICommonView<IsLoginEntity> {
    private DealDetailActivity1 activity;

    public IsLoginViewImpl(DealDetailActivity1 activity) {
    ...
    @Override
    public void onCompleted(IsLoginEntity entity) {
    }
    ...
    @Override
    public Class<IsLoginEntity> getEClass() {
        return IsLoginEntity.class;
    }
}
