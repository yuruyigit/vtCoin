...
public class GoogleAuthActivity1 extends BaseActivity {
    @Bind(R.id.et_code)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_auth1);
    ...
    private void initView() {
        ...
        countDownUtil = new CountDownUtil(this, getCode, Constant.SendCodeTime, 1000, new CountDownUtil.onFinishListener() {
                    @Override
                    public void finish() {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.next:
                if (isNext() && isHasNet()) {
                    toActivity(GoogleAuthActivity2.class);
                }
                break;
        }
    }
