 ...
 * @Date 2017/8/23.
 */
public class TurnInBillActivity extends BaseActivity {
    @Bind(R.id.tabLayout)
    TabLayout tabLayout;
    @Bind(R.id.viewPager)
    ViewPager viewPager;
    ...
    public View getTitleBar() {
        NormalTitleBar normalTitle = getNormalTitleBar().setTitle("转入账单").setRightDrawable(R.mipmap.wallet_bottom_search).setRightListener(new View.OnClickListener() {
            @Override
