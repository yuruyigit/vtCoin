package com.block.vtCoin.mine.setting.email;
...
public class BindEmailAddressActivity extends BaseActivity {
    @Bind(R.id.et_phone)
    ...
    private void initView() {
        tvPhone.setText(getString(R.string.email_address));
        etPhone.setHint(getString(R.string.please_email_address));
        next.setText(getString(R.string.sure_bind));
