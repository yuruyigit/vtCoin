...
public class HttpsUtil
{
     ...
     */
    private static final String[] CERTIFICATES = new String[]{"213983660940391.cer"};
    ...
    /**
     * 获取支持Https的OkHttpClient.Builder
     * <p>
     * 不需要的项目可注释
     *
     * @param context
     * @return
     */
    public static OkHttpClient.Builder getHttpsOkHttpClient(Context context)
    {
        OkHttpClient.Builder builder = new OkHttpClient().newBuilder();

        InputStream[] certificates = HttpsUtil.getCertificates(context, CERTIFICATES);
        SSLSocketFactory sslSocketFactory = HttpsUtil.getSSLSocketFactory(certificates,
                null, null);
    ...
    private static TrustManager[] prepareTrustManager(InputStream... certificates)
    {
        ...
        try
        {
            ...
            //            TrustManager[] keyStoreTrustManagers = trustManagerFactory
            // .getTrustManagers();
    ...
    {
        NotValidateTimeTrustManager[] notValidateTimeTrustManagers = new
                NotValidateTimeTrustManager[trustManagers.length];
