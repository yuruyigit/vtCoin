...
/**
 * Created by liu bin on 2016/10/2.
 * 自定义带箭头动画的进度条
 */

public class MyHeaderView extends FrameLayout implements IHeaderView {
    ...
    private void init() {
        View rootView = View.inflate(getContext(), R.layout.head_refresh, null);
